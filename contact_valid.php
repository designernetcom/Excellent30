...
//print_r($_POST);exit();
 ...
 require_once "recaptchalib.php";
   ...
   // your secret key
   $secret = "6LeIUKghAAAAAMoIWcqkdd4IlstdiqHRjpUkYtQU";
...
if($error=="")
{
    ...
    require 'PHPMailer/PHPMailerAutoload.php';
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $mail->From = 'sales.excellentengineering@gmail.com';
        $mail->FromName ='sales.excellentengineering@gmail.com';
        //$mail->addAddress('sales@netcom-india.com'); 
        $mail->addAddress('sales.excellentengineering@gmail.com'); 
        ...
        $message_body.="<tr><td>Contact's Email : </td><td>".$_POST['email']."</td></tr>";
         $message_body.="<tr><td>Contact's Subject : </td><td>".$_POST['subject']."</td></tr>";
       ...
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Excellent Engineering Company.';
        $mail->isHTML(true);
